...
class ReadersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reader" do
    assert_difference('Reader.count') do
      post readers_url, params: { reader: { avatar: @reader.avatar, birthdate: @reader.birthdate, first_name: @reader.first_name, last_name: @reader.last_name, second_name: @reader.second_name } }
    end
  ...
  test "should update reader" do
    patch reader_url(@reader), params: { reader: { avatar: @reader.avatar, birthdate: @reader.birthdate, first_name: @reader.first_name, last_name: @reader.last_name, second_name: @reader.second_name } }
