class PublishersController < ApplicationController
  ...
  private
    ...
    def publisher_params
      params.require(:publisher).permit(:publisher_name, :publisher_location, :reader_id)
    end

    def check_permissions
      unless ((@publisher.reader==Reader.current) || Reader.current.admin?)
        redirect_to root_url, notice: "You can't edit other's publisher"
      end
    end
end
