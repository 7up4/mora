class ReadersController < ApplicationController
  ...
  before_action :administrative_rights, except: [:show, :edit, :update, :index]
  ...
  private
    ...
    def reader_params
      params.require(:reader).permit(:first_name, :last_name, :second_name, :gender, :birthdate, :avatar)
    end

    def check_permissions
      unless current_reader==@reader
        redirect_to root_url, notice: "You can't edit other's profile"
      end
    end
end
